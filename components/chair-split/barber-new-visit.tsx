...
const defaultHaircut: Service[] = [
  ...
  { emoji: "\u2668\uFE0F", name: "Hot Towel", price: 200, selected: false },
    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="px-5 mt-3 flex items-center gap-2.5">
        <div className="w-8 h-8 rounded-full bg-[#3B82F6] flex items-center justify-center shrink-0">
          <span className="text-[11px] font-semibold text-[#FFFFFF]">KB</span>
        </div>
        <span className="text-[13px] text-[#9CA3AF]">Logging as Karim B.</span>
      </div>
      ...
      {/* Info text */}
      <p className="text-[12px] text-[#9CA3AF] text-center mt-3 pb-8 px-5">
