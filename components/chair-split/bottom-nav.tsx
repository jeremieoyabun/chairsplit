...
function TeamIcon({ color }: { color: string }) {
  return (
    <svg width="26" height="26" viewBox="0 0 564.55 499.29" fill={color} xmlns="http://www.w3.org/2000/svg">
      <path d="M400.88,499.29H0v-61.12c0-76.66,62.15-138.81,138.81-138.81h123.27c76.66,0,138.81,62.15,138.81,138.81v61.12h0Z"/>
      <path d="M425.74,299.37h-38.28c37.94,34.31,61.96,83.74,61.96,138.81v61.12h115.12v-61.12c0-76.66-62.15-138.81-138.81-138.81h.01Z"/>
      <circle cx="200.44" cy="129.48" r="129.48"/>
      <path d="M364.11,0c-12.57,0-24.49,2.36-35.98,5.7,31.1,32.07,50.34,75.69,50.34,123.79s-19.25,91.71-50.34,123.78c11.49,3.34,23.4,5.7,35.98,5.7,71.51,0,129.48-57.97,129.48-129.48S435.62,0,364.11,0Z"/>
    </svg>
  )
}
...
const rightTabs = [
  { Icon: TeamIcon, label: "Team", index: 2 },
  { Icon: FinanceIcon, label: "Finance", index: 3 },
]
  ...
  return (
    <div className="absolute bottom-3 left-4 right-4 z-30">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -top-[40px] z-10">
        ...
        >
          <Plus className="w-[38px] h-[38px] text-[#FFFFFF]" strokeWidth={2.4} />
        </button>
      </div>
